...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    public void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(email, password, mIpAddressView.getText().toString());
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            if(code==UserService.AUTH_SUCCESS){
                return true;
            }
            else if(code==UserService.AUTH_INCORRECT_PWD){
                return false;
            }
            else if(code==UserService.AUTH_DOESNT_EXIST){
                int create_code=service.create(mEmail,mPassword);
                if(create_code==UserService.CREATE_SUCCESS)
                    return true;
                else
                    return false;
            }
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                intent.putExtra("IP_ADDRESS",LoginActivity.this.mIpAddressView.getText().toString());
